...
public class QueueBrowserDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TextMessage message2 = session.createTextMessage("Toddyboy ddzão");
			...
			System.out.println("Message1 received: " + msgReceived.getText());
			msgReceived = (TextMessage) consumer.receive(5000);
			System.out.println("Message2 received: " + msgReceived.getText());
